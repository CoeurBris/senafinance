...
exports.paginationAndRechercheInit2 = exports.paginationAndRechercheInit = void 0;
const data_source_1 = require("./data-source");
function paginationAndRechercheInit(req, table) {
    //initiation pour la pagination
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
    const searchTerm = req.query.mot || '';
    const startIndex = (page - 1) * limit;
    let searchQueries = [];
    if (searchTerm != '') {
        // get fields of entity
        const entityRepository = data_source_1.myDataSource.getRepository(table);
        ...
        // merge all fields
        const allFields = Object.values(manyToOneRelationsAndEntities).flat();
...
exports.paginationAndRechercheInit = paginationAndRechercheInit;
function paginationAndRechercheInit2(req, table) {
    //initiation pour la pagination
    const page = parseInt(req.body.page) || 1;
    const limit = parseInt(req.body.limit) || 10;
    const searchTerm = req.body.mot || '';
    const startIndex = (page - 1) * limit;
    let searchQueries = [];
    if (searchTerm != '') {
        // get fields of entity
...
exports.paginationAndRechercheInit2 = paginationAndRechercheInit2;
