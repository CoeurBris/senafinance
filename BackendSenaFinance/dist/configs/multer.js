...
const storage = multer_1.default.diskStorage({
    destination: (req, file, callback) => {
        ...
        const finalPath = path_1.default.join(UPLOADS_BASE_PATH, subFolder);
 ...
 *     └── ...
 */
const AVATAR_UPLOAD_PATH = path_1.default.join(UPLOADS_BASE_PATH, 'avatars');
 ...
 * ============================================================
 */
const FINANCE_UPLOAD_PATH = path_1.default.join(UPLOADS_BASE_PATH, 'Finances');
